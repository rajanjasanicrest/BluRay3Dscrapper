...
def visit_bluray_website(year):
    with sync_playwright() as p:
        ...
        try:
            ...
            with open(f'data/BluRay-{year}.json', 'r', encoding='utf-8') as f:
        ...
        try:
            ...
            movies_list = []
            try:
                with open(f'3dmovie_list/{year}-list.json', 'r', encoding='utf-8') as f:
            ...
            if not movies_list:
                ...
                with open(f'3dmovie_list/{year}-list.json', 'w', encoding='utf-8') as f:
            ...
            for index, movie_href in enumerate(movies_list):
                ...
                if index%40 == 0 and index!=0:
                    with open(f'data/BluRay-{year}.json', 'w', encoding='utf-8') as f:
